...
![Cricket AI Banner](static/bg.png)
...
```mermaid
graph TD
    A[Video Upload] --> B[Video Segmentation]
    B --> C[Scorecard OCR]
    B --> D[Visual AI Inference]
    C --> E[Timeline Assembly]
    D --> E
    E --> F[Commentary Synthesis]
    F --> G[TTS & Production Merge]
